...
import {StyleSheet, View, TextInput, Alert, Platform, TouchableOpacity} from 'react-native';
  ...
  render() {
    ...
    return (
      <View >
        ...
        <Button full dark={platform === "ios"} onPress={this.handleSignupPress} style={{ margin: 80, marginTop: 20, backgroundColor: "#B08CB2", }} disabled={this.state.loading}>
          <Text>{this.state.loading ? "Please wait" : "Signup"}</Text>
        </Button>
        <Button style={{ margin: 90, marginTop: 10, backgroundColor: "#3B5998", }}>
